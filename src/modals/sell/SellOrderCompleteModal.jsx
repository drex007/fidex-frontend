...
import { SellModal, SellOrderTransactionReceipt } from '../../modalConfigs'

const SellOrderCompleteModal = () => {
    ...
    return (
        <div className='flex justify-end'>
            <div className='px-3 py-4  lg:w-4/6  w-full 3xl:w-3/5 shadow-lg border rounded-xl shadow-gray-400  text-[15px]'>
                ...
                <button className='bg-white border border-black text-black p-2 rounded-md  capitalize  w-full font-african py-4 my-2' onClick={() => setUserModalState(SellOrderTransactionReceipt)}>View Transaction</button>
...
export default SellOrderCompleteModal